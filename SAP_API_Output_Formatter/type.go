...
type ProcessOrderReads struct {
	ConnectionKey      string `json:"connection_key"`
	Result             bool   `json:"result"`
	RedisKey           string `json:"redis_key"`
	Filepath           string `json:"filepath"`
	APISchema          string `json:"api_schema"`
	ManufacturingOrder string `json:"process_order"`
...
type General struct {
			...
			ToComponent                   string `json:"to_ProcessOrderComponent"`
			ToItem                        string `json:"to_ProcessOrderItem"`
			ToOperation                   string `json:"to_ProcessOrderOperation"`
			ToStatus                      string `json:"to_ProcessOrderStatus"`
}
